...
| 语音消息 | 1 | Url, FileType, FileName, FileSize | 存储语音文件URL和元信息 |
| 文件消息 | 2 | Url, FileType, FileName, FileSize | 存储文件URL和元信息 |
| 通话消息 | 3 | AVdata | 存储通话相关数据 |
...
case 1: // 语音消息
    ...
    fmt.Println("语音消息:", message.FileName, message.Url)
