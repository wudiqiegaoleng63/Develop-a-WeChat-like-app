...
func GetUserList(c *gin.Context) {
	...
	// 校验权限
	if !CheckOwner(c, myUserListReq.OwnerId) {
		return
	}
...
func LoadMyJoinedGroup(c *gin.Context) {
	...
	// 校验权限
	if !CheckOwner(c, loadMyJoinedGroupReq.OwnerId) {
		return
	}
...
func DeleteContact(c *gin.Context) {
	...
	// 校验权限：只能删除自己的联系人
	if !CheckOwner(c, deleteContactReq.OwnerId) {
		return
	}
...
func ApplyContact(c *gin.Context) {
	...
	message, ret := gorm.UserContactService.ApplyContact(req)
	JsonBack(c, message, ret, nil)
}
...
func PassContactApply(c *gin.Context) {
	...
	// 校验权限
	if !CheckOwner(c, passContactApplyReq.OwnerId) {
		return
	}
